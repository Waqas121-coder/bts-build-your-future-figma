...
import BestideaArrowDown from "../../Images/BestideaArrowDown.png";
  ...
  let Accordions = [
    {
      HeadingAccourdion: "Chainweaver (wallet & workbench)",
    },
    {
      HeadingAccourdion: "Chainweaver macOS",
    },
    {
      HeadingAccourdion: "Chainweaver Linux",
    },
    {
      HeadingAccourdion: "Chainweaver Windows",
    },
    {
        HeadingAccourdion: "Chainweaver user guide",
      },
      {
        HeadingAccourdion: "Atom IDE",
      },
      {
        HeadingAccourdion: "Block explorer",
      },
      {
        HeadingAccourdion: "Web transfer tools",
      },
      {
        HeadingAccourdion: "Balance checker",
      },
  ];
  const Tools = () => {
    return (
