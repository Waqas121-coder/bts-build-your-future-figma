    ...
    <Container>
      ...
      <Grid container>
        ...
        <Grid item md={9} xs={12}>
          <Box sx={{ ml: {xs:0,md:5},mt:{xs:2, md:0}}} display="flex" flexDirection="column" gap={5}>
            {Accordions.map(({ HeadingAccourdion }, index) => (
              ...
              >
                  <Accordion>
                    ...
                    expandIcon={
                        expanded ? 
                          <RemoveIcon sx={{color:"rgba(173, 0, 255, 1)"}} onClick={() => setExpanded(false)}/> :
                          <AddIcon sx={{color:"rgba(173, 0, 255, 1)"}} onClick={() => setExpanded(true)} />}
                      
                      aria-controls="panel1a-content"
                      id="panel1a-header"
                    >
                      <Typography sx={{ my: 1,fontSize:"24px", fontFamily:"Lato",fontWeight:"700" }}>
                        {HeadingAccourdion}
                      </Typography>
                    </AccordionSummary>
                    <AccordionDetails>
